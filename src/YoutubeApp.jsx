    ...
    <>
      <div className="container">
        <div className="div1">
          ...
          <FontAwesomeIcon id="youtube" icon={faYoutube} /> <b>YouTube</b>
          <sup className="in">IN</sup>
        </div>
        <div className="div2">
          <input
            type="search"
        ...
        <div className="div3">
          ...
          <div className="icon">
            <img
              className="logo"
              src="https://lh3.googleusercontent.com/ogw/AF2bZyjfF3GiuOUfoX6SEDNNYmXGs9b4Jow-vuPs5dJoYp-jgeI=s32-c-mo"
              alt="logo"
            />
          </div>
        </div>
      ...
      <div className="main">
        <div className="sidebar">
          <div className="sidebarItem">
            ...
            <p className="sidebarTitle">
              {" "}
              <FontAwesomeIcon icon={faBolt} /> &nbsp; &nbsp; Shorts
            </p>
            <p className="sidebarTitle">
              {" "}
            ...
            <p className="sidebartext">
              You <FontAwesomeIcon icon={faChevronRight} />
            </p>
            <p className="sidebarTitle" id="icons">
              {" "}
              <SwitchAccountOutlinedIcon /> &nbsp; &nbsp; Your channel
            </p>
            <p className="sidebarTitle">
              {" "}
            ...
            <p className="sidebarTitle">
              {" "}
              <PlaylistPlayOutlinedIcon /> &nbsp; &nbsp; Playlists
            </p>
            <p className="sidebarTitle">
              {" "}
            ...
            <p className="sidebarTitle">
              {" "}
              <FontAwesomeIcon icon={faList} /> &nbsp; &nbsp; All subscriptions
            </p>
            <hr />
            ...
            <p className="sidebarTitle">
              {" "}
              <FontAwesomeIcon icon={faBagShopping} /> &nbsp; &nbsp; Shopping
            </p>
            <p className="sidebarTitle">
              {" "}
              <MusicNoteIcon /> &nbsp; &nbsp; Music
            ...
            <p className="sidebarTitle">
              {" "}
              <FontAwesomeIcon icon={faClapperboard} /> &nbsp; &nbsp; Films
            </p>
            <p className="sidebarTitle">
              <span>
                <svg
                ...
                >
                  ...
                  <path
                    clip-rule="evenodd"
                    d="M8.82789 8.6971C7.05737 10.5181 7.05737 13.4819 8.82789 15.3029L7.39394 16.6971C4.86869 14.0998 4.86869 9.90017 7.39394 7.3029L8.82789 8.6971ZM15.1721 15.3029C16.9426 13.4819 16.9426 10.5181 15.1721 8.6971L16.6061 7.3029C19.1313 9.90017 19.1313 14.0998 16.6061 16.6971L15.1721 15.3029Z"
                    fill="black"
                    fill-rule="evenodd"
                  />
                  <path
                    clip-rule="evenodd"
                    d="M6.69609 6.70772C3.76797 9.63076 3.76797 14.3692 6.69609 17.2923L5.2831 18.7077C1.5723 15.0033 1.5723 8.99665 5.2831 5.29228L6.69609 6.70772ZM17.3039 17.2923C20.232 14.3692 20.232 9.63077 17.3039 6.70772L18.7169 5.29228C22.4277 8.99665 22.4277 15.0033 18.7169 18.7077L17.3039 17.2923Z"
                    fill="black"
                    fill-rule="evenodd"
                  />
                </svg>
            ...
            <p className="sidebarTitle">
              <span>
                <img
                  src="https://img.icons8.com/ios/50/ps-controller.png"
                  alt="gaming"
                />
              </span>
              &nbsp; &nbsp; Gaming
            ...
            <p className="sidebarTitle">
              {" "}
              <FontAwesomeIcon icon={faTrophy} /> &nbsp; &nbsp; Sport
            </p>
            <p className="sidebarTitle">
              {" "}
              <FontAwesomeIcon icon={faLightbulb} /> &nbsp; &nbsp; Courses
            </p>
            <p className="sidebarTitle">
              {" "}
              <FontAwesomeIcon icon={faVestPatches} /> &nbsp; &nbsp; Fashion &
              beauty
            </p>
            <p className="sidebarTitle">
              {" "}
            ...
            <p className="sidebarTitle">
              <span>
                <img
                  src="https://cdn1.iconfinder.com/data/icons/social-media-color-1/128/yumminky-social-media-48-512.png"
                  alt="ytstudio"
                />
              </span>
            ...
            <p className="sidebarTitle">
              <span>
                <img
                  src="https://cdn1.iconfinder.com/data/icons/hayal-social-media-icons/128/youtube.png"
                  alt="ytmusic"
                />
              </span>
            ...
            <p className="sidebarTitle">
              <span>
                <img
                  src="https://cdn2.iconfinder.com/data/icons/round-social-media-icons/58/youtube.png"
                  alt="ytkids"
                />
              </span>
            ...
            <p className="sidebarTitle">
              <span>
                <img
                  src="https://pic.onlinewebfonts.com/thumbnails/icons_306151.svg"
                  alt="feedback"
                />
              </span>
